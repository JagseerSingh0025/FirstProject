...
public class Listeners extends Drivers implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			String Path=Screenshot(Name, driver);// 2. we pass name and drive that will pass the information to
													// screenshot method
			                                        // about these two parameters from this block
			test.get().addScreenCaptureFromPath(Path, Name);// for location of screenshot we set screenshot method
